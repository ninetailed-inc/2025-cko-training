...
export const Product = ({
  ...
  const pdpLayoutStyles = [['lg:col-start-8', 'lg:col-start-1']];
      ...
      <div className="pb-16 pt-6">
        <div className="mx-auto mt-8 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            <div className={`lg:col-span-5 ${pdpLayoutStyles[0][0]}`}>
            ...
            <div
              className={`mt-8 lg:col-span-7 ${pdpLayoutStyles[0][1]} lg:row-span-3 lg:row-start-1 lg:mt-0`}
            >
            ...
            <div className={`mt-8 lg:col-span-5 ${pdpLayoutStyles[0][0]}`}>
              <form>
                {/* Option picker */}
                {product.options &&
